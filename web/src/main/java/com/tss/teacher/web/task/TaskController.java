...
public class TaskController {
    ...
    public PageInfo<TeacherTaskRespVO> getTaskList(@JsonParam(validation = true) TeacherTaskReqVO param, @ApiIgnore @TeacherLoginUser TeacherUser loginUser) {
    ...
    public TaskDetailRespVO getTaskDetail(@JsonParam(validation = true) TaskDetailReqVO param, @ApiIgnore @TeacherLoginUser TeacherUser loginUser) {
        param.setTeacherId(loginUser.getTeacherId());
    ...
    public Long createTask(@JsonParam(validation = true) TaskCreateReqVO param, @ApiIgnore @TeacherLoginUser TeacherUser loginUser) {
        param.setTeacherId(loginUser.getTeacherId());
        param.setTeacherName(loginUser.getTeacherName());
        return taskInterface.createTask(param);
    }

    @ApiOperation(value = "教师更新实验任务", notes = "更新实验任务")
    @RequestMapping(value = "/updateTask", method = RequestMethod.POST)
    public Boolean updateTask(@JsonParam(validation = true) TaskUpdateReqVO param, @ApiIgnore @TeacherLoginUser TeacherUser loginUser) {
        param.setTeacherId(loginUser.getTeacherId());
        param.setTeacherName(loginUser.getTeacherName());
    ...
    public Boolean publishTask(@PathVariable("taskId") Long taskId, @ApiIgnore @TeacherLoginUser TeacherUser loginUser) {
